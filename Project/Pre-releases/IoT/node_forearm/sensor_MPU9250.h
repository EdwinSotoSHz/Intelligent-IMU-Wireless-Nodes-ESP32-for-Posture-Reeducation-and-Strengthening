...
private:
    ...
    const float GYRO_BIAS_X = -610.44;
    const float GYRO_BIAS_Y = 508.60;
    const float GYRO_BIAS_Z = 80.15;

    const float ACC_BIAS_X = 335.62;
    const float ACC_BIAS_Y = -901.03;
    const float ACC_BIAS_Z = 1739.45;
